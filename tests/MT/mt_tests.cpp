...
TEST(MTSBOX, frequency_block_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, longest_run_of_ones_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, binary_matrix_rank_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, discrete_fourier_transform_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, non_overlapping_template_matching_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, overlapping_template_matching_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, universal_digit_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, approximate_entropy_mt) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, cumulative_sums_mt_forward) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
...
TEST(MTSBOX, cumulative_sums_mt_reverse) {
    MT19937SBOX generator;
    std::uint32_t count_number = 16384u;
    std::vector<std::uint32_t> numbers(count_number);
    for (std::uint32_t i = 0; i < count_number; ++i) {
